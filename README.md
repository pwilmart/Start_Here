...
#### <a id="IRS"></a>IRS (Internal Reference Scaling)
...
#### <a id="RTS"></a>RTS (Real Time Search)
...
#### <a id="PAW_TMT"></a>PAW_TMT (TMT Analyses with PAW Pipeline)
...
#### <a id="Other"></a>Other (Other TMT datasets)
...
#### <a id="MS2_TMT"></a>MS2_TMT (MS2-Scan TMT Reporter Ions)
...
#### <a id="SpC"></a>SpC (Spectral Counting with PAW Pipeline)
